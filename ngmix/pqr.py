...
def make_Umean(P,Q,R,S):
    ...
    Uvec[5] = U3[:,0,0,0].mean()
    Uvec[6] = U3[:,0,0,1].mean()
    Uvec[7] = U3[:,0,1,1].mean()
    Uvec[8] = U3[:,1,1,1].mean()

    return Uvec

def make_Uvecs(P,Q,R,S):
    """
    U1 = Q/P
    U2 = R/P
    U3 = S/P
...
def make_W(P, Q, R, S):
    """
    Get W and W inverse from unsheared sim data
    """
    ...
    W[0,0] = (U1[:,0]*U1[:,0]).mean()
    W[0,1] = (U1[:,0]*U1[:,1]).mean()
    W[1,0] = (U1[:,1]*U1[:,0]).mean()
    W[1,1] = (U1[:,1]*U1[:,1]).mean()

    # middle square block
    W[2,2] = (U2[:,0,0]*U2[:,0,0]).mean()
    W[2,3] = (U2[:,0,0]*U2[:,0,1]).mean()
    W[2,4] = (U2[:,0,0]*U2[:,1,1]).mean()

    W[3,2] = (U2[:,0,1]*U2[:,0,0]).mean()
    W[3,3] = (U2[:,0,1]*U2[:,0,1]).mean()
    W[3,4] = (U2[:,0,1]*U2[:,1,1]).mean()

    W[4,2] = (U2[:,1,1]*U2[:,0,0]).mean()
    W[4,3] = (U2[:,1,1]*U2[:,0,1]).mean()
    W[4,4] = (U2[:,1,1]*U2[:,1,1]).mean()

    # bottom right square block
    W[5,5] = (U3[:,0,0,0]*U3[:,0,0,0]).mean()
    W[5,6] = (U3[:,0,0,0]*U3[:,0,0,1]).mean()
    W[5,7] = (U3[:,0,0,0]*U3[:,0,1,1]).mean()
    W[5,8] = (U3[:,0,0,0]*U3[:,1,1,1]).mean()

    W[6,5] = (U3[:,0,0,1]*U3[:,0,0,0]).mean()
    W[6,6] = (U3[:,0,0,1]*U3[:,0,0,1]).mean()
    W[6,7] = (U3[:,0,0,1]*U3[:,0,1,1]).mean()
    W[6,8] = (U3[:,0,0,1]*U3[:,1,1,1]).mean()

    W[7,5] = (U3[:,0,1,1]*U3[:,0,0,0]).mean()
    W[7,6] = (U3[:,0,1,1]*U3[:,0,0,1]).mean()
    W[7,7] = (U3[:,0,1,1]*U3[:,0,1,1]).mean()
    W[7,8] = (U3[:,0,1,1]*U3[:,1,1,1]).mean()

    W[8,5] = (U3[:,1,1,1]*U3[:,0,0,0]).mean()
    W[8,6] = (U3[:,1,1,1]*U3[:,0,0,1]).mean()
    W[8,7] = (U3[:,1,1,1]*U3[:,0,1,1]).mean()
    W[8,8] = (U3[:,1,1,1]*U3[:,1,1,1]).mean()


    # 1-2 cross block
    W[0,2] = (U1[:,0]*U2[:,0,0]).mean()
    W[0,3] = (U1[:,0]*U2[:,0,1]).mean()
    W[0,4] = (U1[:,0]*U2[:,1,1]).mean()

    W[1,2] = (U1[:,1]*U2[:,0,0]).mean()
    W[1,3] = (U1[:,1]*U2[:,0,1]).mean()
    W[1,4] = (U1[:,1]*U2[:,1,1]).mean()
    ...
    # 1-3 cross block
    W[0,5] = (U1[:,0]*U3[:,0,0,0]).mean()
    W[0,6] = (U1[:,0]*U3[:,0,0,1]).mean()
    W[0,7] = (U1[:,0]*U3[:,0,1,1]).mean()
    W[0,8] = (U1[:,0]*U3[:,1,1,1]).mean()

    W[1,5] = (U1[:,1]*U3[:,0,0,0]).mean()
    W[1,6] = (U1[:,1]*U3[:,0,0,1]).mean()
    W[1,7] = (U1[:,1]*U3[:,0,1,1]).mean()
    W[1,8] = (U1[:,1]*U3[:,1,1,1]).mean()
    ...
    # 2-3 cross block
    W[2,5] = (U2[:,0,0]*U3[:,0,0,0]).mean()
    W[2,6] = (U2[:,0,0]*U3[:,0,0,1]).mean()
    W[2,7] = (U2[:,0,0]*U3[:,0,1,1]).mean()
    W[2,8] = (U2[:,0,0]*U3[:,1,1,1]).mean()

    W[3,5] = (U2[:,0,1]*U3[:,0,0,0]).mean()
    W[3,6] = (U2[:,0,1]*U3[:,0,0,1]).mean()
    W[3,7] = (U2[:,0,1]*U3[:,0,1,1]).mean()
    W[3,8] = (U2[:,0,1]*U3[:,1,1,1]).mean()

    W[4,5] = (U2[:,1,1]*U3[:,0,0,0]).mean()
    W[4,6] = (U2[:,1,1]*U3[:,0,0,1]).mean()
    W[4,7] = (U2[:,1,1]*U3[:,0,1,1]).mean()
    W[4,8] = (U2[:,1,1]*U3[:,1,1,1]).mean()
