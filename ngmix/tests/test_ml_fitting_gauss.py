...
import ngmix
from ngmix.fitting import LMSimple, NMSimple, MaxSimple
...
# @pytest.mark.parametrize('wcs_g1', [0])
# @pytest.mark.parametrize('wcs_g2', [0])
# @pytest.mark.parametrize('g1_true', [0])
# @pytest.mark.parametrize('g2_true', [0])
